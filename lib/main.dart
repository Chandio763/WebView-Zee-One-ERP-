...
void main() async {
  ...
  runApp(const MaterialApp(home: WebViewERP()));
}
...
class WebViewERP extends StatefulWidget {
  const WebViewERP({Key? key}) : super(key: key);

  @override
  _WebViewERPState createState() => _WebViewERPState();
}

class _WebViewERPState extends State<WebViewERP> {
  final Completer<WebViewController> _controller =
      Completer<WebViewController>();
  late WebViewController _backController;

  Future<bool> _onWillPop(BuildContext context) async {
    if (await _backController.canGoBack()) {
